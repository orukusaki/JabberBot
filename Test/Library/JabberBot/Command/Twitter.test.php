...
class TwitterTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->bot = $this->getMockBuilder('JabberBot_Bot')->disableOriginalConstructor()->setMethods(array('getRandomQuote'))->getMock();
    ...
    public function testRunAccessDenied()
    {
        ...
        $this->bot->acl->expects($this->once())->method('check')->with($this->equalTo('psmith'), $this->equalTo('/bot/twitter'))->will($this->returnValue(false));
    ...
    public function testRun()
    {
        ...
        $message->expects($this->once())->method('getUsername')->will($this->returnValue('psmith'));
        $this->bot->acl = $this->getMockBuilder('JabberBot_Acl')->getMock();
        $this->bot->acl->expects($this->once())->method('check')->with($this->equalTo('psmith'), $this->equalTo('/bot/twitter'))->will($this->returnValue(true));
        $message->body = '*twitter qahatesyou';
