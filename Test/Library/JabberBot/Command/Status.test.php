...
class StatusTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->bot->expects($this->once())->method('getRandomQuote')->with('status')->will($this->returnValue('status message'));
        ...
        $this->bot->acl->expects($this->once())->method('check')->with($this->equalTo('psmith'), $this->equalTo('/bot/status'))->will($this->returnValue(true));
